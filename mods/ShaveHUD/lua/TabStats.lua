if string.lower(RequiredScript) == "lib/managers/hud/newhudstatsscreen" then
	...
	function HUDStatsScreen:recreate_left(...)
		if ShaveHUD:getSetting({"TabStats", "ENABLED"}, true) then
	...
	function HUDStatsScreen:update(t, ...)
		...
		if self._clock_panel and (self._next_clock_update_t or 0) < t then
			local text = ""
			local mode = ShaveHUD:getSetting({"TabStats", "CLOCK_MODE"}, 3)
			if mode == 4 then
	...
	HUDStatsScreen.STAT_ITEMS = {
		...
		{ name = "total_damage", 		text_id = "shavehud_tabstats_total_damage", 		color = Color(1, 0.69, 0.19, 0.38), update = {func = "session_damage", 					func_alltime = "", 	params = {}					},		no_alltime = true		},
		{ name = "tanks_killed", 		text_id = "shavehud_tabstats_tanks_killed", 		color = Color.red, 					update = {func = "session_total_tanks_killed", 		func_alltime = "total_tanks_killed", 	params = {}							}, 	},
		{ name = "cloakers_killed", 	text_id = "shavehud_tabstats_cloakers_killed", 	color = Color.green,				update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"spooc", "count"}			}, 	},
		{ name = "shields_killed", 		text_id = "shavehud_tabstats_shields_killed", 	color = Color.yellow,				update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"shield", "count"}		}, 	},
		{ name = "snipers_killed", 		text_id = "shavehud_tabstats_snipers_killed", 	color = Color(1, 0.67, 0.84, 0.90),	update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"sniper", "count"}		}, 	},
		{ name = "tasers_killed", 		text_id = "shavehud_tabstats_tasers_killed", 	color = Color(1, 0, 0.55, 0.55), 	update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"taser", "count"}			}, 	},
		{ name = "medic_killed", 		text_id = "shavehud_tabstats_medic_killed", 		color = Color(1, 1, 0.55, 0.24),	update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"medic", "count"}			}, 	},
		{ name = "gensec_killed", 		text_id = "shavehud_tabstats_gensec_killed", 	color = Color(1, 0.75, 1, 0.24),	update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"gensec", "count"}		}, 	},
		{ name = "melee_killed", 		text_id = "shavehud_tabstats_melee_kills", 		color = Color(1, 0.54, 0.02, 0.02),	update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"total", "melee"}			}, 	},
		{ name = "explosion_killed", 	text_id = "shavehud_tabstats_explosion_kills", 	color = Color(1, 1, 0.5, 0),		update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"total", "explosion"}		}, 	},
		{ name = "nonspecials_killed", 	text_id = "shavehud_tabstats_nonspecial_kills", 	color = Color(1, 0.78, 0.15, 0.21),	update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"non_special", "count"}	}, 	},
		{ name = "total_killed", 		text_id = "shavehud_tabstats_total_kills", 		color = Color(1, 0.5, 0.5, 0.21),	update = {func = "session_enemy_killed_by_type", 	func_alltime = "enemy_killed_by_type", 	params = {"total", "count"}	}, 	},
		...
		{ name = "total_revives", 		text_id = "shavehud_tabstats_total_revives", 	color = Color(1, 1, 0, 0.4),		update = {func = "session_total_revives", 			func_alltime = "total_revives",			params = {}							}, 	},
	}
	...
	function HUDStatsScreen:_create_stat_list(panel, ...)
		self._tabstats_settings = {
			FONT_SIZE = ShaveHUD:getSetting({"TabStats", "FONT_SIZE"}, 18),
			COLOR = ShaveHUD:getSetting({"TabStats", "COLOR"}, "rainbow"),
			SHOW_MASK = ShaveHUD:getSetting({"TabStats", "SHOW_MASK"}, true)
		}
		...
		local mask_color = ShaveHUD:getColorSetting({"TabStats", "COLOR"}, "red")
		if self._tabstats_settings.SHOW_MASK then
			...
			if char_data then
				...
				mask_color = ShaveHUD:getSetting({"TabStats", "COLOR"}, "rainbow") == "rainbow" and char_data.color or mask_color
			end
		end
		...
		local items_color = self._tabstats_settings.COLOR ~= "rainbow" and ShaveHUD:getColor(self._tabstats_settings.COLOR or "red") or false
	...
	function HUDStatsScreen:update_setting(setting, value)
		if self._tabstats_settings then

if string.lower(RequiredScript) == "lib/managers/hud/huddriving" then
	HUDDriving.VEHICLES = {
		...
		["Truck"] = {
			...
			texture_rect = { 0, 0, 512, 512},
			texture = "guis/textures/shavehud/drivinghud/truck"
		},
		["Rib Boat"] = {
			...
			texture_rect = { 0, 0, 512, 512},
			texture = "guis/textures/shavehud/drivinghud/boat"
		},
		["Blackhawk"] = {
			...
			texture_rect = { 0, 0, 512, 512},
			texture = "guis/textures/shavehud/drivinghud/blackhawk"
		},
		["Bike"] = {
			["driver"] = 				{ scale_x = -0.02, 	scale_y = 0.35, 	is_seat = true },
			texture_rect = { 0, 0, 512, 512},
			texture = "guis/textures/shavehud/drivinghud/bike"
		}
	}
	...
	function HUDDriving:init(hud)
		...
		self._legend_loot 		= HUDDriving.LegendImageItem:new(self._legend:panel(), self._legend, "legend_loot", HUDDriving._WIDTH / 2, HUDDriving._FONT_SIZE, { texture = "guis/textures/shavehud/drivinghud/legend", text_rect = {0, 0, 128, 128}, show_max = true })
		self._legend_passengers = HUDDriving.LegendImageItem:new(self._legend:panel(), self._legend, "legend_passengers", HUDDriving._WIDTH / 2, HUDDriving._FONT_SIZE, { texture = "guis/textures/shavehud/drivinghud/legend", text_rect = {128, 0, 128, 128}, show_max = true })
	...
	function HUDDriving:apply_settings()
		local settings = ShaveHUD:getSetting({"DrivingHUD"}, {})
	...
	function HUDDriving.VehicleImageItem:init(base_panel, owner, name, width, height, params)
		...
		self._passengers = {}
		self._texture = params.texture or "guis/textures/shavehud/drivinghud/longfellow"
...
elseif string.lower(RequiredScript) == "lib/states/ingamedriving" then
	...
	function IngameDriving:_update_driving_hud()
		...
		if vehicle and vehicle_unit then
			...
			if ShaveHUD:getSetting({"DrivingHUD", "SPEED_IN_MPH"}, false) then
				speed = speed / 1.60934
			end
